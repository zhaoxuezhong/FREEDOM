package com.zxz.freedombase.config.database;
...
@Configuration
@MapperScan(basePackages = "com.zxz.freedombase.dao.dameng", sqlSessionTemplateRef  = "damengSqlSessionTemplate")
public class DataSourceDaMengConfig {
    ...
    public SqlSessionFactory damengSqlSessionFactory(@Qualifier("damengDataSource") DataSource dataSource)
        ...
        bean.setTypeAliasesPackage("com.zxz.freedombase.pojo");
